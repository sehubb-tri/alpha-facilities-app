    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f3f4f6', paddingBottom: '100px' }}>
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: '28px', fontWeight: '700', margin: '0 0 8px 0' }}>
          {rating === 'GREEN'
            ? FURNITURE_RAG_RULES.green.description
            : rating === 'AMBER'
            ? FURNITURE_RAG_RULES.amber.description
            : FURNITURE_RAG_RULES.red.description}
        </h1>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
            <span style={{
              ...
              height: '20px',
              borderRadius: '50%',
              backgroundColor: issues.length <= FURNITURE_RAG_RULES.amber.maxOpenIssues ? '#10b981' : '#ef4444',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              color: '#fff',
              ...
              {issues.length <= FURNITURE_RAG_RULES.amber.maxOpenIssues ? '✓' : '✗'}
            </span>
            <span style={{ fontSize: '14px' }}>
              ≤{FURNITURE_RAG_RULES.amber.maxOpenIssues} open issues ({issues.length} total)
            </span>
          </div>
        </div>
        ...
        {issues.length === 0 && (
          <div style={{
            ...
            <div style={{ fontSize: '14px', color: '#065f46', marginTop: '4px' }}>
              All furniture and decor checks passed.
            </div>
          </div>
        )}
      </div>
