...
export const FurnitureSetup = ({ furnitureChecklist }) => {
  ...
  const selectedZone = selectedType ? FURNITURE_ZONES[selectedType] : null;
  ...
  const handleBegin = () => {
    ...
    furnitureChecklist.initChecklist(campusName, campus, auditorName.trim(), auditorEmail.trim(), selectedType);

    window.scrollTo(0, 0);
    navigate('/furniture/checklist');
  };
      ...
      <div style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
            {CHECKLIST_TYPES.map((type) => {
              const zone = FURNITURE_ZONES[type.id];
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', marginBottom: '12px' }}>
            ...
            <div>
              <div style={{ fontWeight: '600', color: '#059669' }}>{FURNITURE_RAG_RULES.green.description}</div>
              <div style={{ fontSize: '13px', color: '#666' }}>All checks pass, furniture in excellent condition</div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', marginBottom: '12px' }}>
            ...
            <div>
              <div style={{ fontWeight: '600', color: '#d97706' }}>{FURNITURE_RAG_RULES.amber.description}</div>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
            ...
            <div>
              <div style={{ fontWeight: '600', color: '#dc2626' }}>{FURNITURE_RAG_RULES.red.description}</div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '14px', color: '#78350f' }}>
            Some items are marked as <strong>INSTANT RED</strong> (safety hazards, ergonomic requirements). If any of these fail, the campus cannot pass until fixed.
          </div>
